!function(){
    "use strict";
    function e(){
        if(!(this instanceof e))return new e;this.size=0,this.uid=0,this.selectors=[],
    ...
    U(".js-home-repo-card",(e=>{nt.observe(e)}))}();